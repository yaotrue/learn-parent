				...
				<div class="myaccount-lf">
					...
					<ul>
						<li class="current"><a><img
								src="${base }/resources/images/page/arrow-d.png" alt="">我们的使命</a></li>
						<li><a><img
								src="${base }/resources/images/page/arrow-d.png" alt="">我们的特点</a></li>
						<li><a><img
								src="${base }/resources/images/page/arrow-d.png" alt="">领导团队</a></li>
					</ul>
				</div>
				<div class="myaccount-rt">
					<div>
						...
						<div class="myaccount-down">
							<div>
								...
								<p>然而，我们不难发现，中英之间的巨大文化差异还是造成了两国对彼此的不理解，更成为了两国进一步沟通和合作的阻碍。
									在这样的大环境和背景下，一个真正促进中英两国各界交流、能让中英两国社会不同群体之间自由对话的中立平台——中英峰会诞生了。</p>
					...
					<div class="none">
						...
						<div class="myaccount-down trait-down">
							<div class="fir">
								<p>
									<img src="${base }/resources/images/about-us/neu.png">
								</p>
								<div>
									<h5>中立性</h5>
							...
							<div class="sec">
								<p>
									<img src="${base }/resources/images/about-us/div.png">
								</p>
								<div>
									<h5>综合性</h5>
							...
							<div class="thir">
								<p>
									<img src="${base }/resources/images/about-us/sus.png">
								</p>
								<div>
									<h5>持续性</h5>
					...
					<div class="none">
						<h5 class="headline">
							<p>领导团队</p>
							<span> 峰会顾问团成员由杰出的商界、政界、学界及青年领袖担任； </span> <span>董事会成员也由中英两国的优秀人才担任。</span>
						</h5>
						<div class="myaccount-down team-down">
							...
							<div class="team-member clearfix">
								<div class="team-cont-l">
									<img
										src="${base }/resources/images/about-us/adviserpic-michie.png"
								...
								<div class="team-cont-r">
									<div class="team-cont-wapper">
										<div>
											...
											<h5 class="name-ch">英国东亚委员会秘书长麦启安</h5>
											<div class="txt">
												<p>麦启安先生自 2014 年起担任中国国家外国专家局外国专家
													建议咨询委员会顾问,是五位首席顾问中的一员。在此职务 上,麦先生曾 4 次主笔建言报告,向国务院和国务院总理李
													克强就国家政策建言献策。</p>
												<p>2013 年,麦先生被授予中国政府“友谊奖”。此奖是为表彰在
													中国现代化建设中做出贡献的外国专家而设立的最高荣誉奖项。自 2013 年起,麦先生曾多次向中国人民外交学会会长杨文昌
													先生提供建议。2015 年 3 月,在杨文昌会长的邀请下,麦先生陪同由三位前中
													国资深大使组成的公共外交代表团前往英国,考察英国及欧洲政治局势。</p>
											</div>
										</div>
										<p class="info-show events-info-show"></p>
									</div>
								</div>
							</div>
							<div class="team-member clearfix">
								<div class="team-cont-l">
									<img
										src="${base }/resources/images/about-us/adviserpic-henry.jpg" />
								</div>
								<div class="team-cont-r">
									<div class="team-cont-wapper">
										<div>
											<p class="name">Henry Wang</p>
											<h5 class="name-ch">gate国际有限公司总裁</h5>
											<div class="txt">
												<p>EurIng. Henry K. H.
													Wang是一名具有国际水准的顾问、作家和演说家，拥有丰富的全球高端商业经验。他还是位于香港的精品咨询兼投资公司Gate国际有限公司的总裁，同时在全球多家公司、各大咨询公司和国际机构担任董事一职。他经常在全球顶尖高校和商学院发表演讲，并致力于研究国有企业的管理。</p>
							...
							<div class="team-member clearfix">
								<div class="team-cont-l">
									<img
										src="${base }/resources/images/about-us/adviserpic-Alexander.jpg" />
								</div>
								<div class="team-cont-r">
									<div class="team-cont-wapper">
										<div>
											<p class="name">Alexander Chen</p>
											<h5 class="name-ch">博实乐教育集团副总裁</h5>
											<div class="txt">
												<p>陈舒先生目前担任博实乐教育集团副总裁。陈舒先生12岁留学英国，入读 fettes college
													之后考入英国伦敦大学学院,21岁回国筹办英豪剑桥国际高中,成为中国最年轻的校长。2010年，他开始在全国进行义务教育巡讲，推广先进教育理念，并接受了凤凰卫视鲁豫、胡一虎的采访。他现已走遍中国17个省市，授课197场超过50万人次。更曾受邀为中共中央组织部、全国政协、中共中央统战部、新华社
													、人民日报社，团结出版社、中国出版集团、民革中央委员会、明盟中央委员会、九三学社中央委员会、全国文联、全国妇联、英国总领事馆、中国欧盟商会、广东英国商会演讲，并引起强烈反响。2010年，中国英国商会向他颁发了英国商业大奖，他成为了该奖项史上最年轻的获奖者。</p>
											</div>
										</div>
										<p class="info-show events-info-show">
											<i class="icon-down icon-up"></i>
							...
							<div class="team-pic clearfix">
								<div class="fir">
									<a><img
										src="${base }/resources/images/about-us/teampic-lzy.png" /></a>
									<div>
										<h5>李宗洋</h5>
										<p>峰会总策划</p>
										<p>董事会主席</p>
								...
								<div class="sec">
									<a><img
										src="${base }/resources/images/about-us/teampic-qty.png" /></a>
									<div>
										<h5>仇天宇</h5>
										<p>峰会活动负责人</p>
										<p>董事会副主席</p>
								...
								<div class="fir">
									<a><img
										src="${base }/resources/images/about-us/teampic-hugh.png" /></a>
									<div>
										<h5>Hugh Findlay</h5>
										<p>政府联络总监</p>
										<p>峰会董事会董事</p>
								...
								<div class="sec">
									<a><img
										src="${base }/resources/images/about-us/teampic-duncan.png" /></a>
									<div>
										<h5>Duncan McEwan</h5>
										<p>峰会发展总监</p>
										<p>峰会董事会董事</p>
